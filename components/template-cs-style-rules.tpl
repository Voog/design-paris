...
.content-formatted .form_submit input, .content-formatted a.custom-btn, .content-formatted button.custom-btn {
...
.dark-background .content-formatted .form_submit input, .dark-background .content-formatted .form_submit input:hover, .dark-background .content-formatted a.custom-btn, .dark-background .content-formatted a.custom-btn:hover, .dark-background .content-formatted button.custom-btn, .dark-background .content-formatted button.custom-btn:hover {
  border-color: var(--third-color);
  color: var(--third-color);
}
.light-background .content-formatted .form_submit input, .light-background .content-formatted .form_submit input:hover, .light-background .content-formatted a.custom-btn, .light-background .content-formatted a.custom-btn:hover, .light-background .content-formatted button.custom-btn, .light-background .content-formatted button.custom-btn:hover {

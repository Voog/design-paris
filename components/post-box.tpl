<article class="post">
  <div class="post-position">
    <a class="post-top" href="{{ article.url }}">
      {% if article.data.post_image.url %}<div class="background-image" style="background-image: url('{{ article.data.post_image.url }}'); top: {{ article.data.post_image.top }}px; left: {{ article.data.post_image.left }}px;"></div>{% endif %}

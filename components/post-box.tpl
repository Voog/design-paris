<article class="post post-position">
  <a class="post-top" href="{{ article.url }}">
    {% if article.data.image.url %}<div class="background-image" style="background-image: url('{{ article.data.image.url }}'); top: {{ page.data.image.top }}px; left: {{ page.data.image.left }}px;"></div>{% endif %}
